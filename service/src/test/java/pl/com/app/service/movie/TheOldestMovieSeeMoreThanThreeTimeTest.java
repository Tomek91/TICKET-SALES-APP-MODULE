...
public class TheOldestMovieSeeMoreThanThreeTimeTest {
    @Mock
    ...
    public void test1() {
        ...
        Optional<Movie> theOldestMovieWatchMoreThanThree = movieService.theOldestMovieWatchMoreThanThree();

        Assertions.assertAll(
                () -> Assertions.assertTrue( theOldestMovieWatchMoreThanThree.isPresent()),
                () -> Assertions.assertEquals("FILM3", theOldestMovieWatchMoreThanThree.get().getTitle())
        );
    }
    @Test
    ...
    public void test2() {
        ...
        Assertions.assertAll(
                () -> Assertions.assertTrue( theOldestMovieWatchMoreThanThree.isPresent()),
                () -> Assertions.assertEquals("FILM2", theOldestMovieWatchMoreThanThree.get().getTitle())
        );
    }
    @Test
    ...
    public void test3() {
        ...
        Assertions.assertAll(
                () -> Assertions.assertTrue( theOldestMovieWatchMoreThanThree.isEmpty())
        );
    }
