...
public class MostProfitTest {
    ...
    @Test
    @DisplayName("when find most profit movie")
    public void test1() {
        ...
        Optional<Movie> movieOpt = movieService.theMostProfitMovie();

        Assertions.assertAll(
                () -> Assertions.assertTrue(movieOpt.isPresent()),
                () -> Assertions.assertEquals("FILM2", movieOpt.get().getTitle())
        );
    }

    @Test
    @DisplayName("when find most profit movie - loyalty card is up")
    public void test2() {
    ...
    @Test
    @DisplayName("when find most profit movie - customer not have free slots")
    public void test3() {
        ...
        Mockito
                ...
                .thenAnswer(x -> {
                    if (x.getArgument(0).equals(21)){
                        ...
                        return  Optional.of(LoyaltyCard.builder().id(22).expirationDate(LocalDate.now().minusDays(33L)).discount(BigDecimal.TEN).moviesNumber(7).build());
                    } else if(x.getArgument(0).equals(23)){
                        return  Optional.of(LoyaltyCard.builder().id(23).expirationDate(LocalDate.now().minusWeeks(2L)).discount(new BigDecimal(11)).moviesNumber(3).build());
                    } else {
                        return Optional.empty();
